...
@foreach($matchs as $match)
    <table class="table" style=" text-align: center">
      ...
      <tbody>
        <tr>
          ...
          <td scope="row" style=" text-align: center">Finish</td>
          <td scope="row" style="text-align: center">{{$match->weather}}</td>
        </tr>
      </tbody>
    </table>
    <p></p>
    ...
    <button type="button" class="btn btn-primary" onclick="window.location='{{ url("Match/bet") }}'">Bet</button>
